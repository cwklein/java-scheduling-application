...
Directions: Hopefully the UI is self-explanatory, but for the sake of being thorough the user should do as follows:
  ...
  (L)From 'login' the user can:
      Enter the desired username and password in the corresponding fields and press submit, if both fields are correct then the application will move to 'appointments' as the default screen.

  From here going forward, if the user is in one of the main pages listed below then they can navigate to:
